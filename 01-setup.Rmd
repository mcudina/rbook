...
factors(161)
```
Note the line `i=i+1` in the above code. That is the line which allows the `condition` of the `while` loop to update at every cycle through the loop and to eventually exit the loop. 
